...
//** reset slow to head and start from bigining while removing loop  .
 ...
 public static void removeTheLoop(Node head)
 {
  ...
  while(fast!=null && fast.next!=null){
    ...
    //  prev = fast;
      fast = fast.next.next;
      if(slow==fast ){
          // found loop set prev.next to null;
         // prev.next = null;
         // System.out.println("prv:"+prev.data);
  ...
  slow = head;
         ...
         while(slow.next!=fast.next){
             ...
             fast = fast.next ;//.next;
             System.out.println("Fast --loop "+fast.data);
             System.out.println("slow --loop "+slow.data);
         }
         fast.next =null;
         System.out.println("Fast"+fast.data);
